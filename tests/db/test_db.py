...
# TODO: Needs to be updated to use YFinance fake data!
...
# TODO: Need to be update these tests when a test database is implemented
...
#     assert pull_data.timestamp[0].date() == start_date_delta.date()

#     pull_data = database_api.get_db_data(key, end_date=end_date_delta)
#     assert pull_data.timestamp[-1].date() == end_date_delta.date()
